// =============================================================================
//  exp_data - lookup data for core::mlwExp(f64), core::mlwExp2(f64) and core::mlwPow(f64)
//
//  From Arm optimized-routines, obtained via musl libc (math/exp_data.c).
...
constexpr int N = (1 << EXP_TABLE_BITS);
