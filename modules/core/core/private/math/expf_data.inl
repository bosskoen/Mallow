// =============================================================================
//  exp2f_data - lookup data for core::mlwExp2f(f32), core::mlwExpf(f32) and core::mlwPowf(f32)
//
//  From Arm optimized-routines, obtained via musl libc (math/exp2f_data.c).
...
static constexpr int N = (1 << EXP2F_TABLE_BITS);
