...
template<> struct NumericLimits<uint128> {
    ...
    static constexpr uint128 max = (~(uint128)0);
};
template<> struct NumericLimits<int128> {
    static constexpr int128 min = ((int128)1 << 127);
    static constexpr int128 max = ~((int128)1 << 127);
};
#endif
} // namespace core
