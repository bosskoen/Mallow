...
set(MLW_ARCH_X64   FALSE)
set(MLW_ARCH_ARM64 FALSE)
set(MLW_ARCH_ARM32 FALSE)
set(MLW_ARCH_X86 FALSE)


if(CMAKE_SYSTEM_PROCESSOR MATCHES "x86_64|AMD64")
    add_compile_definitions(MLW_X64)
    set(MLW_ARCH_X64   TRUE)
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "arm64|aarch64")
    add_compile_definitions(MLW_ARM64)
    set(MLW_ARCH_ARM64 TRUE)
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "arm")
    add_compile_definitions(MLW_ARM32)
    set(MLW_ARCH_ARM32 TRUE)
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "i386|i686|x86")
    add_compile_definitions(MLW_X86)
    set(MLW_ARCH_X86 TRUE)
else()
    message(FATAL_ERROR "MLW: unknown architecture: ${CMAKE_SYSTEM_PROCESSOR}")
endif()